...
exports.default = function () {
    ...
    var log = function log() {
        ...
        (_console = console).log.apply(_console, [_chalk2.default.dim('[' + (0, _moment2.default)().format('HH:mm:ss') + '] [write-file-webpack-plugin]')].concat(append)); // eslint-disable-line
    };
